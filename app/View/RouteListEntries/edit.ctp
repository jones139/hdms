...
<?php echo $this->Form->create('RouteListEntry'); ?>
	<fieldset>
		<legend><?php echo __('Edit Route List Entry'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RouteListEntry.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('RouteListEntry.id'))); ?></li>
